...
#
# install:
#   curl -sL https://raw.githubusercontent.com/jackspirou/termconfig/mac/yosemite/master/install.sh | bash
#
#   curl -sL https://raw.githubusercontent.com/jackspirou/termconfig/mac/yosemite/master/install.sh chrome iterm atom | bash
#
...
curl -sL https://raw.githubusercontent.com/jackspirou/termconfig/mac/yosemite/master/install_wget.sh | bash
...
do
    case $arg in
        "chrome" )
          # Install Chrome
          curl -sL https://raw.githubusercontent.com/jackspirou/termconfig/mac/yosemite/master/install_chrome.sh | bash
          ;;
        "iterm" )
          # Install iTerm2
...
# Configure Trackpad
curl -sL https://raw.githubusercontent.com/jackspirou/termconfig/mac/yosemite/master/config_trackpad.sh | bash
...
# Configure Finder
curl -sL https://raw.githubusercontent.com/jackspirou/termconfig/mac/yosemite/master/config_finder.sh | bash
...
# Install oh-my-zsh
curl -sL https://raw.githubusercontent.com/jackspirou/termconfig/mac/yosemite/master/install_oh-my-zsh.sh | bash
